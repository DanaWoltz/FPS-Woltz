...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        public bool projectileCheck = true;
        public Image bulletSpeedIndicator;
        ...
        public void UpdateProjectileTag()
        {
            if (Input.GetKeyDown(KeyCode.Q) && projectileCheck == true)
            {
                projectileCheck = false;
                bulletSpeedIndicator.color = Color.red;

            }
            else if (Input.GetKeyDown(KeyCode.Q) && projectileCheck == false)
            {
                projectileCheck = true;
                bulletSpeedIndicator.color = Color.green;
            }
        }
